...
const schema = z.object({
  email: z.string({ required_error: t('bo.forms.errors.required')}).email('Invalid email'),
  password: z.string({ required_error: t('bo.forms.errors.required')}).min(8, 'Must be at least 8 characters')
})
